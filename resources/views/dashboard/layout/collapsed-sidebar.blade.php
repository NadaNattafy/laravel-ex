...
<head>
    <meta charset="UTF-8">
    <title>Collapsed Sidebar Layout</title>
...
<body class="skin-blue sidebar-collapse sidebar-mini" dir="rtl">
<!-- Site wrapper -->
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/public/_admin/AdminLTE-RTL-master/dist/img/user6-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/public/_admin/AdminLTE-RTL-master/dist/img/user6-128x128.jpg" class="user-image" alt="User Image">
